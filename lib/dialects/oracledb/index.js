...
class Client_Oracledb extends Client_Oracle {
  ...
  acquireRawConnection() {
    ...
    const asyncConnection = new Promise(function (resolver, rejecter) {
      ...
      if (client.connectionSettings.clientInitiated !== undefined) {
        oracleDbConfig.clientInitiated =
          client.connectionSettings.clientInitiated;
      }

      if (client.connectionSettings.events !== undefined) {
        oracleDbConfig.events = client.connectionSettings.events;
      }
